...
export const foodCategories: FoodCategories = {
	...
	drinks: ["CocaCola", "Coffee-1", "Coffee", "Drink", "Juice", "Milk"],
};

const FoodIconComponent: React.FC<{ activity: string; iconSize: number }> = ({
	activity,
	iconSize,
}) => {
	const IconGenerator = foodIcons[activity];

	return <IconGenerator height={iconSize} width={iconSize} />;
};
