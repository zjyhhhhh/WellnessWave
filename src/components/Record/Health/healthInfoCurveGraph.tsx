...
const BodyInfoCurveGraphDisplay: React.FC<BodyInfoCurveGraphDisplayProps> = ({
	icon,
	type,
	value,
}) => {
	...
	return (
		<View style={styles.secondRowBox}>
			...
			<View style={styles.currentValueContainer}>
				<Text style={styles.currentValueText}>{value[value.length - 1]}</Text>
